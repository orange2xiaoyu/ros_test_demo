...
void joyCallback(const sensor_msgs::Joy::ConstPtr& msg)
{
    ...
    }else if (msg->buttons[10] - last_msg.buttons[10] == 1.0){
    ...
    twist.linear.x = (msg->axes[4]?(msg->axes[4] + msg->axes[7]):(msg->axes[1]+ msg->axes[7]))*linear_scale;
    twist.angular.z = (msg->axes[3]?(msg->axes[3] + msg->axes[6]):(msg->axes[0]+ msg->axes[6]))*angular_scale;
